...
let sum4_5 = lab4_5[0] + lab4_5[1] + lab4_5[2] + lab4_5[3] + lab4_5[4] + lab4_5[5]
                + lab4_5[6] + lab4_5[7] + lab4_5[8] + lab4_5[9] + lab4_5[10]
let sum6 = 0

let sums = [sum1,sum2,sum3,sum4_5,sum6]

let total_score = 100*(sums/6*0.6 + quiz1*0.4)/40
...
const results = {
    ...
    total_score: 100*(sums/6*0.6 + quiz1*0.4)/40
}
console.log(results)
